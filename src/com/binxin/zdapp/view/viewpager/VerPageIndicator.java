 ...
 * 创建者：邠心
 */
public class VerPageIndicator extends View implements VerIndicator
{
    ...
    public VerPageIndicator(Context context) {
        this(context, null);
    }

    public VerPageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.vpiCirclePageIndicatorStyle);
    }

    public VerPageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultOrientation = res.getInteger(R.integer.default_circle_indicator_orientation_v);
