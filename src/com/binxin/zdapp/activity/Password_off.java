...
public class Password_off extends Activity
{
	private String edt1;
		...
		btn1.setOnClickListener(new OnClickListener()
		{
			public void onClick(View v)
			{
				try
				{
					...
					if (edt1.equals(edt2))
					{
						Toast.makeText(getApplicationContext(),"已关闭通讯录加密",Toast.LENGTH_SHORT).show();
						SharedPreferences sube3 = getSharedPreferences("Zdapp_MyContact", Context.MODE_PRIVATE);
						SharedPreferences.Editor edit0 = sube3.edit();
						edit0.putBoolean("passWord", false);
						edit0.commit();
						finish();
					}
					else
