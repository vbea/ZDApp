...
public class Settings extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
					...
					public void onClick(DialogInterface dialog, int item)
					{
						...
						switch(item)
						{
							...
							case 3:
								...
								break;
							case 4:
								edit.putInt("countUnit", 500);
								break;
							case 5:
								edit.putInt("countUnit", 1000);
								break;
						}
						edit.commit();
						dialog.cancel();
		...
		btn_language.setOnClickListener(new OnClickListener()
		{
			public void onClick(View v)
			{
				String[] items = {getString(R.string.str_default), "English","简体中文"};
				SharedPreferences sube = getSharedPreferences("zdapp", Context.MODE_PRIVATE);
	...
	{
		int code = sube1.getInt("themeCode", 0);
