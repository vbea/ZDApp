...
{
	public static void setThemeColor(Activity content,int resid)
	{
	...
	public static void setThemes(Activity content,LinearLayout lin,int code)
	{
		getThemes(lin,code);
		setThemeColor(content,code);
		//new MainApplication().getConfig(content);
	}
	public static void getThemes(LinearLayout lin,int code)
	{
		switch(code)
		{
			case 0:
	...
	public static void getRThemes(RelativeLayout lin,int code)
	{
	...
	public static void setImage(ImageView lin,int code)
	{
		//lin.setBackgroundColor(Color.parseColor("#4F000000"));
		switch(code)
		{
